...
class Agent:
    def __init__(self, env=None, epsilon=1.0, epsilonDecay=0.0001, epsilonMin=0.1, isTraining=True, gamma=0.9, learningRate=0.003, batchSize = 32, trainFreq=5):
        if not env:
...
plt.title("DQN Learning Reward over Time {}".format(envName))
plt.savefig("DeepQLearningResults/" + envName + ".png")

figure2 = plt.figure("Losses")
plt.plot(losses)
plt.ylabel("Loss")
plt.xlabel("Episode Count (10s of Episodes)")
plt.title("DQN Average Loss over Time {}".format(envName))
plt.savefig("DeepQLearningResults/" + envName + "Loss.png")

figure3 = plt.figure("Time")
plt.plot(times)
plt.ylabel("Time")
plt.xlabel("Episode Count (10s of Episodes)")
plt.title("DQN Average Time of Episode over Trained Episode Count {}".format(envName))
plt.savefig("DeepQLearningResults/" + envName + "Time.png")
...
with open("DeepQLearningResults/" + envName + ".csv", 'w') as f:
    write = csv.writer(f)
...
with open("DeepQLearningResults/" + envName + "Loss.csv", 'w') as f:
    write = csv.writer(f)
...
with open("DeepQLearningResults/" + envName + "Time.csv", 'w') as f:
    write = csv.writer(f)
